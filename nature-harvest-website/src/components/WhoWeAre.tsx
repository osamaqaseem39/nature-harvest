...
const WhoWeAre = () => {
  ...
  return (
    <>
      ...
      <section ref={sectionRef} className="relative bg-gradient-to-br from-green-100 via-green-50 to-green-100 pt-32 sm:pt-40 md:pt-50 lg:pt-60 pb-16 sm:pb-20 -mt-10 sm:-mt-16 lg:-mt-20 overflow-hidden">
